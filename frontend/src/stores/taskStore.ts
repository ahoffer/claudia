...
interface TaskStore {
    ...
    sttProvider: 'deepgram' | 'browser' | 'whisper';
    whisperUrl: string;
    ...
    setSttProvider: (provider: 'deepgram' | 'browser' | 'whisper') => void;
        ...
        }),
        {
            ...
            merge: (persistedState, currentState) => {
                ...
                return {
                    ...
                    sttProvider: persisted.sttProvider ?? currentState.sttProvider,
                    whisperUrl: persisted.whisperUrl ?? currentState.whisperUrl,
