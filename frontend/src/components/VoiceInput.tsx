...
import { useSttRecognition } from '../hooks/useSttRecognition';
...
export const VoiceInput = forwardRef<VoiceInputHandle, VoiceInputProps>(function VoiceInput(
    ...
    // deepgramApiKey is consumed inside useSttRecognition via the store.
    useTaskStore(s => s.deepgramApiKey); // keep subscription so re-render on key change
